...
<meta name="description" content="Results Post"/>
...
$p1q1Val = $_POST["p1q1response"];
$p1q2Val = $_POST["p1q2response"];
$p1q3Val = $_POST["p1q3response"];
$p1q4Val = $_POST["p1q4response"];
$p1q5val = $_POST["p1q5response"];
//product 2 results placed into variables
$p2q1Val = $_POST["p2q1response"];
$p2q2Val = $_POST["p2q2response"];
$p2q3Val = $_POST["p2q3response"];
$p2q4Val = $_POST["p2q4response"];
$p2q5val = $_POST["p2q5response"];
//product 3 results placed into variables
$p3q1Val = $_POST["p3q1response"];
$p3q2Val = $_POST["p3q2response"];
$p3q3Val = $_POST["p3q3response"];
$p3q4Val = $_POST["p3q4response"];
$p3q5val = $_POST["p3q5response"];
...
else if ($p1q1Val== "maybe"){$plq1answer="maybe";
}
else {
